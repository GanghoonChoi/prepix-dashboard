export const team = {
  en: {
    ...
    "team.step3": "3. Ready",
    "team.previewTerms":
      "{seats} member seats · reviewers are free · creating one does not charge you",
    "team.remaining": "You can create {count} more.",
    "team.creating": "Creating workspace…",
    "team.inviteDesc": "Invitations expire in 7 days. You can skip this step.",
    ...
    "team.cloudDesc":
      "Upload and the shared team archive arrive in the next release.",
    "team.acceptTitle": "You have a team invitation",
    "team.acceptDesc": "Joining does not change your personal subscription.",
    "team.invitedTo": "Workspace",
    "team.invitedAs": "You will join as",
    "team.accept": "Join workspace",
    "team.accepting": "Joining…",
    "team.alreadyAccepted": "This invitation was already accepted.",
    ...
    "team.verifyPending":
      "{count} invitation(s) are waiting. Verify your email to join.",
    ...
    "team.verifyDoneDesc": "You can now accept team invitations.",
    ...
    "team.error.EMAIL_VERIFICATION_RATE_LIMITED":
      "Too many verification emails. Wait a few minutes and use the newest link.",
    "team.seatRequest": "Ask the owner ({email}) to add seats.",
    ...
    "team.error.WORKSPACES_UNREACHABLE":
      "We could not reach the team service. Try again in a moment.",
    "team.error.WORKSPACES_EMPTY":
      "Your workspace is still being prepared. Try again in a moment.",
    "team.error.WORKSPACE_CREATE_LIMIT_REACHED":
      "You have reached the workspace limit for this account.",
    ...
    "team.error.INVITATION_UNAVAILABLE":
      "This invitation link is unavailable. Ask for a new invitation.",
    ...
    "team.seatSplit": "An unaccepted invitation holds a seat.",
    "team.capsTitle": "What each role can do",
    "team.capsHint": "An admin cannot make anyone an owner.",
    "team.caps.ownership": "Transfer ownership, appoint admins",
    "team.caps.people": "Invite, change roles, suspend, remove",
    "team.caps.exceptAdmin": "Not admins",
    "team.caps.can": "Can do",
    "team.caps.close": "Close",
    "team.caps.archive": "Upload and download originals",
    "team.caps.seat": "Uses a paid seat",
    "team.caps.yes": "Yes",
    "team.caps.no": "No",
    "team.startPersonalTitle": "Your personal space is ready",
    "team.startPersonalBody":
      "Nobody else can see it. You can create a team any time.",
    "team.startTeamName": "Team name",
    "team.startTeamHint": "You can invite people in the next step.",
    "team.startNoTeam":
      "You have no team yet, so there is nobody to invite. Create one above, or carry on.",
  },
  ko: {
    "team.title": "워크스페이스",
    ...
    "team.cloudDesc": "업로드와 팀 아카이브 공유는 다음 출시에 추가됩니다.",
    "team.acceptTitle": "팀 초대를 받았습니다",
    "team.acceptDesc": "참여해도 개인 구독은 변경되지 않습니다.",
    "team.invitedTo": "워크스페이스",
    "team.invitedAs": "참여 역할",
    "team.accept": "워크스페이스 참여",
    "team.accepting": "참여하는 중…",
    "team.alreadyAccepted": "이미 수락한 초대입니다.",
    ...
    "team.verifyPending":
      "받은 팀 초대가 {count}개 있습니다. 이메일을 인증하면 참여할 수 있습니다.",
    ...
    "team.verifyDoneDesc": "이제 팀 초대를 수락할 수 있습니다.",
    ...
    "team.error.EMAIL_VERIFICATION_RATE_LIMITED":
      "인증 메일을 너무 많이 요청했습니다. 몇 분 뒤 가장 최근 링크를 사용하세요.",
    "team.seatRequest": "소유자({email})에게 좌석 추가를 요청하세요.",
    "team.seatRequestAction": "소유자에게 메일 보내기",
    "team.error.WORKSPACES_DISABLED":
      "이 환경에서는 팀 온보딩을 아직 사용할 수 없습니다. 개인 계정으로 계속 이용할 수 있습니다.",
    "team.error.WORKSPACES_UNREACHABLE":
      "팀 서비스에 연결하지 못했습니다. 잠시 후 다시 시도해주세요.",
    "team.error.WORKSPACES_EMPTY":
      "워크스페이스를 준비하고 있습니다. 잠시 후 다시 시도해주세요.",
    "team.error.WORKSPACE_CREATE_LIMIT_REACHED":
      "이 계정에서 만들 수 있는 워크스페이스를 모두 만들었습니다.",
    "team.error.WORKSPACE_CREATION_UNAVAILABLE":
    ...
    "team.error.REQUEST_FAILED":
      "요청을 완료하지 못했습니다. 연결을 확인하고 다시 시도해주세요.",
    "team.error.WORKSPACE_PERSONAL_INVITE_FORBIDDEN":
      "개인 공간에는 초대할 수 없습니다. 팀을 만들어 초대하세요.",
    "team.error.WORKSPACE_PERSONAL_DELETE_FORBIDDEN":
      "개인 공간은 삭제할 수 없습니다.",
    "team.error.WORKSPACE_PERSONAL_MEMBERS_FORBIDDEN":
      "개인 공간에는 멤버가 없습니다.",
    "team.error.WORKSPACE_PERSONAL_LEAVE_FORBIDDEN":
      "개인 공간은 탈퇴할 수 없습니다.",
    "team.error.WORKSPACE_PERSONAL_TRANSFER_FORBIDDEN":
      "개인 공간은 다른 사람에게 넘길 수 없습니다.",
    "team.kind.personal": "개인 공간",
    "team.kind.team": "팀",
    "team.personalTitle": "내 개인 공간",
    "team.personalDesc": "나만 보는 공간입니다. 멤버도 좌석도 없습니다.",
    "team.personalOne": "다른 사람과 함께 일할 때 팀을 만드세요.",
    "team.teamsHeading": "팀",
    "team.spaceHeading": "내 공간",
    "team.makeTeam": "팀 만들기",
    "team.personalNoMembers": "개인 공간에는 멤버도, 역할도, 초대도 없습니다.",
    ...
    "team.seatSplit": "수락 전 초대도 좌석을 잡습니다.",
    "team.capsTitle": "역할별 권한",
    "team.capsHint": "관리자는 누구도 소유자로 지정할 수 없습니다.",
    "team.caps.ownership": "소유권 이전 · 관리자 지정",
    "team.caps.people": "초대 · 역할 변경 · 참여 정지 · 제거",
    "team.caps.exceptAdmin": "관리자 제외",
    "team.caps.can": "할 수 있는 일",
    "team.caps.close": "닫기",
    "team.caps.archive": "아카이브 원본 업로드 · 다운로드",
    "team.caps.seat": "유료 좌석 사용",
    "team.caps.yes": "가능",
    "team.caps.no": "불가",
    "team.startPersonalTitle": "개인 공간이 준비되었습니다",
    "team.startPersonalBody":
      "다른 사람에게는 보이지 않습니다. 팀은 언제든 만들 수 있습니다.",
    "team.startTeamName": "팀 이름",
    "team.startTeamHint": "다음 단계에서 팀원을 초대할 수 있습니다.",
    "team.startNoTeam":
      "아직 팀이 없어서 초대할 사람도 없습니다. 위에서 팀을 만들거나 계속 진행하세요.",
  },
};
